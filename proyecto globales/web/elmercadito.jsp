                    ...
                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                        <div class="product__details__tab__desc">
                            <div class="latest-product__item__pic">
                                <img src="img/product/mercadito.png" alt="">
                            </div>
                            <p>El Mercadito es un supermercado dedicado a darle al consumidor los mejores precios y productos frescos</p>
                        </div>
                    </div>
                    <div class="tab-pane" id="tabs-2" role="tabpanel">
                        <div class="product__details__tab__desc">
                            <p> Ubicación: 100 metros este del parque de Tarrazu.</span></p>
                            <p>Contacto:<span> 2711-9999</span></p>
                            <p>Email:<span> mercadito@gmail.com</span></p>
                        </div>
                    </div>
                        ...
                        <div class="product__details__tab__desc">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="img/mario.jpg"class="img img-rounded img-fluid">

                                        </div>
                                        <div class="col-md-10">
                                            <p>
                                                <a class="float-left" ><strong>Mario López Montenegro</strong></a>
                                            ...
                                            <p>El servicio estuvo un poco lento.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
