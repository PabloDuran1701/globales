                    ...
                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                        <div class="product__details__tab__desc">
                            <div class="latest-product__item__pic">
                                <img src="img/product/quetzal.jpg" alt="">
                            </div>
                            <p>Super Quetzal es un supermercado dedicado al sector comercio. Le ofrecemos a las familias de la zona
                                los precios más bajos del mercado, para ayudar a que ahorren y vivan mejor</p>
                        </div>
                    </div>
                    <div class="tab-pane" id="tabs-2" role="tabpanel">
                        <div class="product__details__tab__desc">
                            <p> Ubicación: 600 metros este del parque de Santa María de Dota.</span></p>
                            <p>Contacto:<span> 2222-6572</span></p>
                            <p>Email:<span> superquetzal@gmail.com</span></p>
                        </div>
                    </div>
